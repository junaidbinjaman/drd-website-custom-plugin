import useGetWholesaleSalesReport from '@/hooks/useGetWholesaleSalesReport';
...
export default function WholesaleSalesReport() {
    const {startDate, endDate} = useSalesReportDateData();
    const {isLoading, data} = useGetWholesaleSalesReport(
        startDate as Date,
        endDate as Date,
    );
